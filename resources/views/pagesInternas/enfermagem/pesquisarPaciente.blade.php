  ...
  <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-outline-info" title="Fazer relatório" href="{{route('relatorio-enfermagem', [$paciente->id])}}" role="button">
          ...
          <td>
            <a class="btn btn-outline-warning" title="Ver relatórios" href="{{route('lista-relatorios', [$paciente->id])}}" role="button">
          ...
          <td>
            <a class="btn btn-outline-warning" title="Ver prescrição médica" href="{{route('lista-prescricoes', [$paciente->id])}}" role="button">
